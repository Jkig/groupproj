...
function App() {
  ...
  return (
    <div className='body'>
      <ul>
        <li className='horizontal'> <TextSide text={textNative} className="TextSideL"/> </li>
        <li className='spacer50'></li>
        <li className='horizontal'> <TextSide text={textTarget} className="TextSideR"/> </li>
      </ul>
    </div>
  )
}
